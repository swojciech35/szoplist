...
export const ScreenArray=[
    ...
    {route: "Create New List",label:'Nowa Lista ',component:CreateShopList,unmountOnBlur:true,initialParams:{name: "", list:[]},headerShown:false,iconName:'plus',iconType:"feather",display:true},
    {route: "Select products screen",label:'Wybierz produkty ',component:SelectProductsScreen,initialParams:{name: "",list:[]},unmountOnBlur: true,headerShown:false,iconName:'hand-pointer-o',iconType:'font-awesome',display:false},
